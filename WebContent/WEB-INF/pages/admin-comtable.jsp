  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">企业</strong>/<small>管理界面</small></div>
      </div>
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-3">
          ...
          <form method="post" action="<%=request.getContextPath()%>/commanage.do" style="display:flex;flex-direction:row;">
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
                <th class="table-check"><input type="checkbox" /></th><th class="table-id">ID</th><th class="table-title">公司名称</th><th class="table-type">联系人</th><th class="table-author am-hide-sm-only">联系电话</th><th class="table-date am-hide-sm-only">招聘岗位</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
              <c:forEach items="${complist}" var="com">
              <tr>
                <td><input type="checkbox" /></td>
                <td>${com.id}</td>
                <td><a href="#">${com.cname}</a></td>
                <td>${com.boss}</td>
                <td class="am-hide-sm-only">${com.tel}</td>
                <td class="am-hide-sm-only">${com.job}</td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="<%=request.getContextPath() %>/deleteCompany.do?id=${com.id}" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                    </div>
                  </div>
                </td>
              </tr>
