        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
                <th class="table-check"><input type="checkbox" /></th><th class="table-id">ID</th><th class="table-title">姓名</th><th class="table-type">出生日期</th><th class="table-author am-hide-sm-only">性别</th><th class="table-date am-hide-sm-only">毕业院校</th><th class="table-set">操作</th>
              </tr>
              </thead>
              ...
              <tr>
                ...
                <td>${mem.id}</td>
                <td><a href="#">${mem.name}</a></td>
                <td>${mem.birth}</td>
                <td class="am-hide-sm-only">${mem.sex}</td>
                <td class="am-hide-sm-only">${mem.graschool}</td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="<%=request.getContextPath() %>/deleteMember.do?id=${mem.id}" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                    </div>
                  </div>
                </td>
              </tr>
